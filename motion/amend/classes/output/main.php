 ...
 */
namespace plenumtype_amend\output;
...
class main implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $data->amendment = format_text($data->plugindata->amendment, FORMAT_MOODLE, [
        ...
        $fs = get_file_storage();
        $data->attachments = [];
        foreach ($fs->get_area_files($this->context->id, 'mod_plenum', 'attachments', $data->id) as $file) {
        ...
        $type = new \plenumtype_amend\type($this->motion, $this->context);
