...
class type extends base_type {
    /** Plugin component */
    const COMPONENT = 'plenumtype_resolve';

    /** Whether information should be shown on motion */
    const DETAIL = true;

    /** @var $component */
    public string $component = 'plenumtype_resolve';
    ...
    public static function in_order($context, $immediate) {
        return has_capability('mod/plenum:meet', $context)
            && $immediate
            && ($immediate->motion->get('type') == 'open');
    }
    ...
    public function needs_second() {
        return get_config('plenumtype_resolve', 'requiresecond')
