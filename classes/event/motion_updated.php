...
/**
 * The motion_updated event class.
 *
 * @package     mod_plenum
 * @category    event
 ...
 */
class motion_updated extends base {
    /**
     * Init method.
     *
     * @return void
    ...
    public static function get_name() {
        return get_string('motion_updated', 'mod_plenum');
    }
    ...
    public function get_description() {
        return "The user with the id '$this->userid' updated the motion with id '$this->objectid'" .
