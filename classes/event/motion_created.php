...
/**
 * The motion_created event class.
 *
 * @package     mod_plenum
 * @category    event
 ...
 */
class motion_created extends base {
    /**
     * Init method.
     *
     * @return void
    ...
    public static function get_name() {
        return get_string('motion_created', 'mod_plenum');
    }
    ...
    public function get_description() {
        return "The user with the id '$this->userid' created a motion with id '$this->objectid'" .
