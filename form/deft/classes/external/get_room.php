...
class get_room extends external_api {
    ...
    public static function execute($contextid): array {
        ...
        return [
            ...
            'autogaincontrol' => get_config('block_deft', 'autogaincontrol'),
            'echocancellation' => get_config('block_deft', 'echocancellation'),
            'noisesuppression' => get_config('block_deft', 'noisesuppression'),
        ];
    }
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            ...
            'roomid' => new external_value(PARAM_TEXT, 'Meeting room id'),
            'server' => new external_value(PARAM_TEXT, 'Server url for room'),
            'autogaincontrol' => new external_value(PARAM_BOOL, 'Use auto gain control'),
            'echocancellation' => new external_value(PARAM_BOOL, 'Use echo cancellation'),
            'noisesuppression' => new external_value(PARAM_BOOL, 'noisesuppression'),
        ]);
    }
}
